...
public class Bullet extends CircularCollidableObject
{
	...
	AnimeCounter.AnimPackage animPackageNormal;
    AnimeCounter.AnimPackage animPackageBurst;
	...
	public Bullet()
	{
        ...
        animPackageNormal = new AnimeCounter.AnimPackage(Assets.bullet_state_arr,AnimeCounter.ANIME_REVERSE,-1,2);
        animPackageBurst = new AnimeCounter.AnimPackage(Assets.bullet_burst_arr,AnimeCounter.ANIME_ONCE,1,8);
	}
