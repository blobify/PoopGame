...
public class Musca extends CircularCollidableObject {
    ...
    public void interactWithFood(Food food) {
        // if within range
        if (food.collidable && food.pos.y > pos.y && CollidableObject.checkCircleCircleCollision(pos, Food.RANGE, food.pos, 0)) {
